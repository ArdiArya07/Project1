              ...
              <div class="col-lg-12">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Registrasi Akun!</h1><h6>Aplikasi Layanan Pengaduan Masyarakat</h6>
                  </div>
                  <form class="user" method="post" action="register-proses.php">
                    ...
                    <div class="form-group">
                      <input type="text" name="telp" class="form-control form-control-user" placeholder="Masukkan Nomor Telephone...">
                    </div>
